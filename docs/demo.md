...
- [Отчет о тестировании системы](#отчет-о-тестировании-системы)
  - [1. Архитектура стенда](#1-архитектура-стенда)
  - [2. Базовый функционал и Observability](#2-базовый-функционал-и-observability)
  - [3. Сценарии отказа](#3-сценарии-отказа)
    - [Отказ Application-узла (gitea-node-01)](#отказ-application-узла-gitea-node-01)
    - [Демонстрация восстановления gitea-node-01](#демонстрация-восстановления-gitea-node-01)
    - [Отказ Master-узла БД](#отказ-master-узла-бд)
    - [Демонстрация восстановления db-node-01](#демонстрация-восстановления-db-node-01)
    - [Отказ узла хранения (storage-01)](#отказ-узла-хранения-storage-01)
    - [Демонстрация восстановления storage-01](#демонстрация-восстановления-storage-01)
    - [Отказ балансировщика (proxy-01)](#отказ-балансировщика-proxy-01)
    - [Демонстрация восстановления прокси-01](#демонстрация-восстановления-прокси-01)
  - [4. Резервное копирование](#4-резервное-копирование)
  - [5. Пример восстановления из снапшота](#5-пример-восстановления-из-снапшота)
      - [восстановление Storage](#восстановление-storage)
      - [восстановление бд из снапшота](#восстановление-бд-из-снапшота)
...
итого в дашборде отображается актуальная информация
  ![Тест записи](./images/final.png)
